...
if(isset($_POST['uploadphoto']))
{
    ...
    {
      $_SESSION['photoname']=generateRandomString().'.'.$imageFileType;
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],"uploads/".$_SESSION['photoname'])) {
            echo $_SESSION['cropphoto']='uploads/'.$_SESSION['photoname'];
            echo $_SESSION['uploadphoto']=$_SESSION['photoname'];
...
<body>
    ...
    <form action="uploadphoto.php" method="post" enctype="multipart/form-data" target="upload_frame" onsubmit="submit_photo()">
    ...
    <form action="uploadphoto.php" method="post" onsubmit="return checkCoords();">
